...
class SwiftStorage(dafPersist.StorageInterface):
    ...
    def write(self, butlerLocation, obj):
        ...
        butlerLocation.storage = dafPersist.PosixStorage('/', create=False)
    ...
    def exists(self, location):
        ...
        """
        if isinstance(location, dafPersist.ButlerLocation):
    ...
    def getRepositoryCfg(uri):
        ...
        try:
            storage = SwiftStorage(uri, create=False)
        except dafPersist.NoRepositroyAtRoot:
            return None
        try:
